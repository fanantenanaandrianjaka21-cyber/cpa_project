        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    ?>
                    <a href=""class="btn btn-secondary btn-round" data-toggle="modal"
                        data-target="#modal-materiel"><i class="fa fa-plus"></i>  Stock</a>
                    <a href="{{ route('mouvement.liste')}}"class="btn btn-secondary btn-round">Mouvement de Stocks</a>
                    <table id="bootstrap-data-table-export" class="table table-hover table-responsive table-bordered">
                        ...
                        <tbody>
                            @foreach ($materielpartype as $materielpartype)
                                <tr>
                                    <td class="text-center">{{ $materielpartype['type'] }}</td>
                                    <td>{{ $materielpartype['quantite'] }}</td>
                                    <td>Centre Antsirabe</td>
                                    ...
                                    <td>
                                        <div class="pull-right hidden-phone">
                                            <a href="{{ route('materiel.partype_centre', $materielpartype['type']) }}"
                                                class="btn btn-info btn-xs">Voir tous</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
