...
?>
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('gestionMateriels') }}"
                        class="nav-item nav-link {{ $active_tab == 'stock' ? 'active' : '' }}"><i class="fa fa-laptop"></i>Stocks</a>
                    <a href="{{ route('tousLesMateriels') }}" class="nav-item nav-link {{ $active_tab == 'materiel' ? 'active' : '' }}"><i
                            class="fa fa-laptop me-2"></i>Materiels</a>
                    <a href="{{ route('affectation.liste') }}" class="nav-item nav-link {{ $active_tab == 'affectation' ? 'active' : '' }}"><i
                    ...
                    <a href="chart.html" class="nav-item nav-link {{ $active_tab == 'maintenance' ? 'active' : '' }}"><i
                            class="fa fa-cogs"></i> Maintenance</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link {{ $active_tab == 'utilisateur' ? 'active' : '' }}"
